...
if __name__ == '__main__':
    ...
    code_x, code_y, vocab_inv = data_helper.pre_processing(df_lang, 'text', 'lang_code')
    ...
    # unpack results 
    train_data, test_data, valid_data, shape, vocab_inv = results
